...
import { ArrowLeft, Plus, Truck, Calendar, Fuel } from 'lucide-react-native';
    ...
    <>
      <Stack.Screen
        options={{
          ...
          headerRight: () => (
            <Pressable onPress={() => router.push('/transport/new' as any)} className="ml-4">
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              action={{ label: 'Add Event', onPress: () => router.push('/transport/new' as any) }}
            />
          }
        />
      </SafeAreaView>
