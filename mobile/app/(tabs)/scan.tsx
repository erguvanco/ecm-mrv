...
import { QrCode, Flashlight, FlashlightOff, History } from 'lucide-react-native';
      ...
      <View className="flex-1">
        ...
        <SafeAreaView edges={['top']}>
          <View className="flex-row items-center justify-between px-4 py-2">
            ...
            >
              {torch ? (
                <Flashlight color="yellow" size={20} />
              ) : (
        ...
        <View className="flex-1 bg-black/60 items-center pt-8">
          ...
          <Text className="text-slate-400 text-xs">
            Supports: Feedstock, Production, Sequestration codes
          </Text>
