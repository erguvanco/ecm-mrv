  ...
  for (let q = 1; q <= 3; q++) {
    ...
    const corc = await prisma.cORCIssuance.create({
      data: {
        ...
        // Full calculation breakdown (use || 0 for nullable fields)
        cStoredTCO2e: period.cStoredTCO2e || 0,
        cBaselineTCO2e: period.cBaselineTCO2e || 0,
        cLossTCO2e: period.cLossTCO2e || 0,
        persistenceFractionPercent: period.persistenceFractionPercent || 0,
        eProjectTCO2e: period.eProjectTCO2e || 0,
        eLeakageTCO2e: period.eLeakageTCO2e || 0,
        netCORCsTCO2e: period.netCORCsTCO2e || 0,
